...
export function categoryLabel(category: MediaCategory | null): string {
...
export function groupCollectionsByCategory(collections: Collection[]): {
  ...
  // Sort: categorized first (alphabetically by label), Uncategorized last
