  ...
  return (
    <aside className="flex h-full w-full flex-col border-r border-ink-200 bg-white">
      ...
      <div className="border-y border-ink-100 px-5 py-4">
        <div className="text-[11px] uppercase tracking-widest text-ink-400">Artist</div>
      ...
      <div className="flex-1 overflow-y-auto px-3 py-4">
        <div className="px-2 pb-2 text-[11px] uppercase tracking-widest text-ink-400">Collections</div>
        {groups.length === 0 ? (
          <div className="px-2 py-6 text-center">
            <FolderOpen className="mx-auto h-6 w-6 text-ink-300" />
            <p className="mt-2 text-sm text-ink-400">No collections yet.</p>
          </div>
        ) : (
