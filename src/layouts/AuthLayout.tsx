...
export default function AuthLayout({
  ...
  return (
    <div className="flex min-h-screen flex-col lg:flex-row">
      ...
      <div className="relative hidden flex-1 overflow-hidden bg-ink-900 lg:flex lg:flex-col lg:justify-between">
        <div
        ...
        />
        <div className="relative z-10 flex items-center gap-2.5 px-12 py-10 text-ink-50">
          <Archive className="h-5 w-5" />
          <span className="font-serif text-xl tracking-tight">Archive</span>
        </div>
        <div className="relative z-10 px-12 pb-16">
          <p className="max-w-md font-serif text-3xl leading-snug text-ink-50 text-balance">
      ...
      <div className="flex flex-1 items-center justify-center px-6 py-12 sm:px-12">
        <div className="w-full max-w-sm">
          ...
          <p className="mt-8 text-center text-sm text-ink-500">
            {altText}{' '}
            <Link to={altLinkTo} className="font-medium text-ink-900 underline-offset-4 hover:underline">
              {altLinkLabel}
            </Link>
          </p>
        </div>
